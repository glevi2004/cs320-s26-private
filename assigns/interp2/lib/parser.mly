...
expr_(last):
  | "let" rec_="rec"? name=VAR_ID args=arg* annot=delim(":", ty)? "="
    e1=expr "in" e2=last
...
pattern2:
  | p1=pattern2 "::" p2=pattern2 { Pattern.cons $loc p1 p2 }
  | p=pattern3 { p }
...
pattern3:
  ...
  | c=CONSTR_ID arg=pattern3? { Pattern.constr $loc c arg }
...
expr4:
  ...
  | c=CONSTR_ID arg=expr5? { Expr.constr $loc c arg }
  | e=expr5 es=expr5+ { Expr.app $loc e es }
  | e=expr5 { e }
